<?php
class Admin_Form_LichBieu extends Zend_Form{
    ...
    {  	
		...
		$file->setLabel('Upload file')
			 ...
			 ->setDestination(BASE_PATH . '/upload/files/lich_bieu')
		...
		$link = $url->url(array('module' => 'admin','controller' => 'lich-bieu','action' => 'index'),null,true);
