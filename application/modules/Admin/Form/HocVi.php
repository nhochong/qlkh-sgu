<?php
class Admin_Form_HocVi extends Zend_Form{
    ...
    {  	
		...
		$link = $url->url(array('module' => 'admin','controller' => 'hoc-vi','action' => 'index'),null,true);
        ...
        $this->setDecorators(array(
					'FormElements',
					array('HtmlTag', array('tag' => 'table','class' => 'hoc_vi')),
					'Form',
					));
    }
}