<?php
class Admin_Form_HDNT extends Zend_Form{
	...
	public function updateField($name, $data, $id) {
		...
		//tao selectbox thanh_vien dua vao value cua selectbox don_vi
		$tv = 'thanh_vien_' . $id;
    ...
    {  	
		...
		$this->addDisplayGroup(array('dsdt'),'function',array(
			'order' => 13,
        	'decorators' => array(
                 'FormElements',
        		 array(array('data' => 'HtmlTag'), array('tag' => 'td')),
