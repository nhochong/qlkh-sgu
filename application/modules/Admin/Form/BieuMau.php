<?php
class Admin_Form_BieuMau extends Zend_Form{
    ...
    {  	
		...
		$lbmOptions = array("multiOptions" => Khcn_Api::_()->getDbTable('loai_bieu_mau', 'default')->getListAssoc());	
		$ma_loai = new Zend_Form_Element_Select('ma_loai',$lbmOptions);
		$ma_loai->setLabel('Loại biểu mẫu')
				->setDecorators(array(
							    'ViewHelper',
							    'Errors',
		...
		$file->setLabel('Upload file')
			 ...
			 ->setDestination(BASE_PATH . '/upload/files/bieu_mau')
			 ->setRequired(true)
		...
		$link = $url->url(array('module' => 'admin','controller' => 'bieu-mau','action' => 'index'),null,true);
