<?php
class Admin_Form_LinhVuc extends Zend_Form{
    ...
    {  	
        ...
        $mo_ta->setLabel('Mô tả')
	          ...
	          ->setDecorators(array(
								    ...
								    array('Label', array('tag' => 'td')),
								    array(array('row' => 'HtmlTag'), array('tag' => 'tr'))))
			  ->setAttribs(array('id' => 'mo_ta','class' => 'textarea','rows' => '4'));	   
		...
		$ma_loai->setLabel('Loại lĩnh vực')
				->setDecorators(array(
							    'ViewHelper',
							    'Errors',
							    array(array('data' => 'HtmlTag'), array('tag' => 'td')),
        ...
        $this->setDecorators(array(
					'FormElements',
					array('HtmlTag', array('tag' => 'table','class' => 'linh_vuc')),
					'Form',
					));
    }
}